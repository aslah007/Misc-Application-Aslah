...
class CricketNets extends StatefulWidget {
  const CricketNets({super.key});

  @override
  State<CricketNets> createState() => _CricketNetsState();
}

class _CricketNetsState extends State<CricketNets> {
  @override
